...
def main(args):
    ...
    val_ds = CustomImageDataset(root=args.data,transform=transform,ignored=args.ignored)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weight_decay', type=float, default=1e-4, help='weight decay cpoefficient')
