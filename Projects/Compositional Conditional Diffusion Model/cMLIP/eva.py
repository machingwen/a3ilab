...
if __name__ == "__main__":
    ...
    parser.add_argument('--data', type=str, default="data/phison_R0805", help="path of test dataset")
    parser.add_argument('--encoder_path', type=str, default="/root/notebooks/nfs/work/barry.chen/Phison/Conditional_Diffusion/CDDIM/cMLIP/checkpoint/exp/NoMiss/model_10.pth")
    parser.add_argument('--num_condition', type=int, nargs='+', help="number of classes in each condition")
    parser.add_argument('--projection_dim', type=int, default=512, help="Dimension of image and class porjection")
