...
args = Args()
#w_values = [0.1 * i for i in range(0, 11)]
...
# 加載模型
    ...
    epoch = 500
    ckpt = torch.load(f"/home/a3ilab01/Desktop/chiu.li/MPD/checkpoint/MED_pth_w_ISIC/w_{mpd_w}_lr5.0e-06/model_epoch{epoch}_lr5.0e-06_w{mpd_w}.pth")["model"]
    ...
    # 構建數據加載器
    valid_ds = CustomImageDatasetCondition_MPD(data_root="/home/a3ilab01/Desktop/chiu.li/MPD/split_ISIC/", dataset_type="test", transform=transform)
    ...
    # 創建圖片儲存目錄
    save_dir = f"/home/a3ilab01/Desktop/chiu.li/MPD/generate_result/w_{mpd_w}"
