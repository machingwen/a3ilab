...
def get_model(args, time_cond_proj_dim=None):
    if args.arch == "unet":
        from models.unet import UNet
        model = UNet(
            T=args.num_timestep,
            num_atr=args.pretrained_nums_cond[0],
            num_obj=args.pretrained_nums_cond[1],
            model_channels=args.emb_size,
            ch_mult=args.channel_mult,
            num_res_blocks=args.num_res_blocks,
            dropout=False,
        ...
        #from models.unet import UNetAdaGN
        from models.unet import ResBlockAdaGN
        model = UNetAdaGN(
            T=args.num_timestep,
            num_atr=args.num_condition[0],
            num_obj=args.num_condition[1],
