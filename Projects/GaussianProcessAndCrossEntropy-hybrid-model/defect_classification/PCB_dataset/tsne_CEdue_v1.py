...
from due import dkl_Phison_mo, dkl_Phison_exp1
...
#     )
    ...
    model = dkl_Phison_exp1.DKL(feature_extractor)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        choices=["PHISON_regroup3", "PHISON_regroup_six"],
        help="Pick a dataset",
    )
    parser.add_argument(
...
#     )
    ...
    training_loader, validation_loader, test_loader = CreateTSNEdataset_regroup_six(args["random_seed"], tsne=True)
