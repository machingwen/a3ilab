...
def HybridExpert(y_pred_expert_detector, y_pred_expert_classifier, y_pred_expert_component, y_true, name_label_list,  df, args_due, train_component_label, val_component_label, test_component_label):
    ...
    for idx, (pred_expert_detector, pred_expert_classifier, pred_expert_component, gt_label, name) in enumerate(list(zip(y_pred_expert_detector, y_pred_expert_classifier, y_pred_expert_component, y_true, name_label_list))):
...
#     input_size, num_classes, train_dataset, test_dataset, train_loader, train_com_loader = ds
    ...
    if args_due.test_inference == True:
        ...
        name_label_list, y_pred_expert_component  = EXP_component(args_due , model,gp_model ,test_loader, test_component_name_df_Expert2, train_component_label, val_component_label, test_component_label ,likelihood ,TH,TH_2 ,good_num_com)
