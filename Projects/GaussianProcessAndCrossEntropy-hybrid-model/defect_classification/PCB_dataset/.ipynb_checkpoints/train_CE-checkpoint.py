...
#         writer.add_scalar("OoD/auprc", aupr, trainer.state.epoch)
        ...
        test_loss = test_cls_loss #test_com_loss + test_cls_loss
...
#         evaluator.run(test_loader)
        ...
        val_loss = val_cls_loss #val_com_loss + val_cls_loss
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset",
        default="PHISON",
        choices=["CIFAR10", "CIFAR100", "PHISON" ,'PHISON_regroup','PHISON_regroup2','PHISON_regroup3', 'PHISON_threecls','PHISON_fourcls'],
        help="Pick a dataset",
    )
