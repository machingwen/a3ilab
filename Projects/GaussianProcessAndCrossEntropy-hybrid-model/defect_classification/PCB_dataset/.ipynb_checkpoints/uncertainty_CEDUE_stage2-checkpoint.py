...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset",
        default="PHISON",
        choices=["CIFAR10", "CIFAR100", "PHISON",'PHISON_regroup','PHISON_regroup2','PHISON_regroup3','PHISON_good','PHISON_shift','PHISON_broke','PHISON_short'],
        help="Pick a dataset",
    )
...
#     exp_2_tau2 = std_threshold_dict['exp_2_tau2']
    ...
    com_15_tau1 = std_threshold_dict['com_15_tau1']
    com_15_tau2 = std_threshold_dict['com_15_tau2']
    com_16_tau1 = std_threshold_dict['com_16_tau1']
    com_16_tau2 = std_threshold_dict['com_16_tau2']
    com_17_tau1 = std_threshold_dict['com_17_tau1']
    com_17_tau2 = std_threshold_dict['com_17_tau2']
