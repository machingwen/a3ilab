...
def set_model(args, args_due,train_com_loader , num_com):
    ...
    feature_extractor_s1 = feature_extractor
    ...
    if torch.cuda.is_available():
        ...
        feature_extractor_s1 = feature_extractor_s1.cuda()
        likelihood = likelihood.cuda()
#         cudnn.benchmark = True
        gpmodel_s1.load_state_dict(ckpt)
        feature_extractor_s1.load_state_dict(ckpt_mlp)
...
def HybridExpert(y_pred_expert_detector, y_pred_expert_classifier, y_pred_expert_classifier, y_true, name_label_list,  df, args_due, train_component_label, val_component_label, test_component_label):
...
#     input_size, num_classes, train_dataset, test_dataset, train_loader, train_com_loader = ds
    ...
    if args_due.test_inference == True:
        ...
        name_label_list, y_pred_expert2  = EXP2(args_due , model,gp_model ,test_loader, test_component_name_df_Expert2, train_component_label, val_component_label, test_component_label ,likelihood ,TH,TH_2 ,good_num_com)
