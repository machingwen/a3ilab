...
#     clust.load(f'/home/a3ilab01/Desktop/jason/HybridExpert_GPGMM/clust/1212_pretrain_all_clustimage_model')
...
def CreateDataset_regroup_due_2_sixcls(seed , add_test, testing=None):
    ...
    clust = Clustimage(method='pca')
    clust.load(f'/root/notebooks/clust/1212_pretrain_all_clustimage_model')
#     clust.load(f'/home/a3ilab01/Desktop/jason/HybridExpert/clust/1212_pretrain_all_clustimage_model')
