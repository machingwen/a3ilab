...
def set_loader(args_due):
    ...
    if args_due.dataset2 == 'phison':
        ...
        if args_due.dataset == 'PHISON':
            train_df, val_df, test_df, train_component_label, val_component_label, test_component_label, train_com_df = CreateDataset_relabel_fourcls(args_due.random_seed, add_test=True, testing=None)
...
#             import pdb;pdb.set_trace()
        ...
        elif ((pred_expert1 == pred_expert2) or ((pred_expert2 != 0) and (pred_expert1 != 0))) and (pred_expert2 !=2):
...
parser.add_argument(
    "--dataset",
    default="PHISON",
    choices=["CIFAR10", "CIFAR100", "PHISON",'PHISON_regroup','PHISON_fourcls','PHISON_shift','PHISON_broke','PHISON_short'],
    help="Pick a dataset",
)
