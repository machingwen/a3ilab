...
#     cl.load(f'/root/notebooks/DUE/clust/{args_due.random_seed}_pretrain_all_clustimage_model')
#     good_num_com = len(set(cl.results['labels']))
#     num_com = len(set(cl.results['labels']))+2
    print(num_classes)
