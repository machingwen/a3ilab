...
python main_gemma.py -load yes -train yes -recount yes -check yes -relu yes -data siqa_short -dropout_method normal -input input_model -output my_new_model  -lr 1e-5 

python main_gemma.py -load yes -train yes -recount yes -check yes -relu yes -data siqa_short -dropout_method normal -input my_new_model -output my_new_model  -lr 1e-5 
