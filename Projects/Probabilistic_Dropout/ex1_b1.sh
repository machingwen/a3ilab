...
python main_gemma.py -load yes -train yes -recount no -check yes -relu yes -data siqa_short -dropout_method normal -input input_model -output my_new_model  -lr 1e-5 
