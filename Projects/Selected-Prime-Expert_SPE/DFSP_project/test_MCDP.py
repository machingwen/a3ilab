...
def cal_all_stats(S_attr_exp1,all_logits,all_attr_gt,all_pair_gt,pairs,yfs,stats):
    ...
    # 計算3位專家綜合準確度
    tabel_pred_ep123 = choose_best_three_expert(S_attr_exp1,S_pair_exp2,S_attr_exp3,all_attr_gt,all_pair_gt)
...
def test_yfs_ep2_nfs_ep1(
    ...
    table_pred_yfs_ep23_nfs_ep1 = choose_best_three_expert(S_attr_exp1,S_pair_exp2,S_attr_exp3,all_attr_gt,all_pair_gt)
