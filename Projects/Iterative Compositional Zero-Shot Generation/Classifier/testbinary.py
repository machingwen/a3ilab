...
if __name__ == "__main__":
    ...
    parser.add_argument('--data', type=str, default='/workspace/DiT/Classifier/CelebA1000', help='dataset location')
    parser.add_argument('--batch_size', type=int, default=128, help='batch size')
    parser.add_argument('--save_folder', type=str, default="Corrects")

    
    # Data hyperparameters
    parser.add_argument("--attr_ckpt", type=str, default='/workspace/DiT/Classifier/classifier/exp/CelebA_itr3_0/best_attr.pth')
    parser.add_argument("--obj_ckpt", type=str, default='/workspace/DiT/Classifier/classifier/exp/CelebA_itr3_0/best_obj.pth')
