...
def main(args):
    ...
    save_root = os.path.join(os.getcwd(), 'classifier', args.exp, args.dir)
   ...
   # print(f"Number of samples in attr_trainds: {len(attr_trainds)}")
    ...
    for epoch in range(1, args.epoch + 1):
        ...
        for image, label in progress_bar:
            ...
            with torch.no_grad():
                ...
                corrects += torch.sum((pred >= 0.5) == label)
                progress_bar.set_postfix({"loss": f"{loss.item():.4f}"})
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='C:/Users/Code/DiT/Classifier/CelebA', help='dataset location')
    ...
    parser.add_argument('--epoch', type=int, default=15, help='total training epochs')
    ...
    parser.add_argument('--dir', type=str, default='CelebA_itr2_03', help='model weight directory')
